 ...
 * <p>
 * To use the component, simply add it to your view hierarchy. Then in your {@link android.app.Activity} or {@link android.support.v4.app.Fragment} call {@link #setViewPager(android.support.v4.view.ViewPager)} providing it
 * the ViewPager this layout is being used for.
 * <p>
 * The colors can be customized in two ways. The first and simplest is to provide an array of colors via {@link #setSelectedIndicatorColors(int...)}. The alternative is via the {@link com.google.samples.apps.iosched.ui.widget.SlidingTabLayout.TabColorizer}
...
public class SlidingTabLayout extends HorizontalScrollView {
	/**
	 * Allows complete control over the colors drawn in the tab layout. Set with {@link #setCustomTabColorizer(com.google.samples.apps.iosched.ui.widget.SlidingTabLayout.TabColorizer)}.
	 */
